...
* https://github.com/entropyx/gocql/pull/181 - this patch would otherwise require a multi-node cluster to be booted as part of the CI build
* https://github.com/entropyx/gocql/pull/179 - this bug can only be reproduced under heavy load in certain circumstances
